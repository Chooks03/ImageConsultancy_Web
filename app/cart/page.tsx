...
export default function CartPage() {
  ...
  const proceedToPayment = () => {
    if (cartItems.length === 0) {
      toast({ title: "Cart Empty", description: "Please add bookings to cart first.", variant: "destructive" });
      return;
    }
    sessionStorage.setItem("pendingBookingList", JSON.stringify(cartItems));
    router.push("/payment");
  };
